      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
        ...
        <div className="relative flex-1 sm:w-48">
          <button
            ...
            className="w-full px-4 py-2.5 pl-10 pr-10 text-sm rounded-xl border border-sage hover:border-sage-dark focus:border-sage-dark transition-colors bg-background text-gray-600 font-normal text-left"
          >
